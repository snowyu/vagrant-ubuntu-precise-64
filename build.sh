...
#hash file-roller 2>/dev/null || { echo >&2 "ERROR: file-roller not found. Install it by typing 'sudo apt-get install file-roller'. Aborting."; exit 0; }
...
SEED_ISO_URL="http://releases.ubuntu.com/precise/$BASE_NAME.torrent"
